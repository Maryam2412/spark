...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="breadcrumb-area-switchgrid">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="gridswitch-store.html">Switch grid</a> <span class="divider">|</span></li>
						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/grid-switch.png" data-zoom-image="img/product/grid-switch.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">Synergy 1 Gang 13A Switched Socket </a></h3>
									<div class="price">
										<span>Rs.999</span>
									...
									<p>Synergy 1 Gang 13A Double Pole Switched Socket Outlet White.
										Conform to BS 1363 - Part 2 : 1995.
										Front plate: white thermoset.
										Supplied with optional faceplate screw caps.
										Options available as standard with red ‘power on’ LED indicator - red LED ‘power on’ upgrade pack also available.
										2 earth terminals.</p>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Synergy 1 Gang 13A Double Pole Switched Socket Outlet White.</p>
													<ul id="product-desc-t">
														<li>Frequency:	50-60 Hz</li>
														<li>Nominal current:	13 A</li>
														<li>Nominal voltage:	250 V</li>
														<li>Storage temperature:	-5-40 °C </li>
														<li>Voltage type:	AC</li>
														<li>Surface protection:	Metallic</li>
