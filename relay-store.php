...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="breadcrumb-area-relays">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
								...
								<div role="tabpanel" class="tab-pane active" id="home">
									<div class="row">
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="relay1-relays-store.html">
													...
													<div class="product-action">
														<div class="button-top">
															<a href="relay1-relays-store.html" ><i class="fa fa-search"></i></a>
												...
												<div class="product-content">
													<h3><a href="#">Normally open output for non-zero-cross</a></h3>
													<div class="price">
														<span>Rs.800</span>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="relay2-relays-store.html">
														<img src="img/product/relay1-1.png" alt="" />
														<img class="secondary-img" src="img/product/relay1-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="relay2-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
												...
												<div class="product-content">
													<h3><a href="#">DCNHS Series 1000V DC Max Relay</a></h3>
													<div class="price">
														<span>Rs.1500</span>
														<span class="old">Rs.1600</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="relay3-relays-store.html">
														<img src="img/product/relay2-1.png" alt="" />
														<img class="secondary-img" src="img/product/relay2-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="relay3-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
												...
												<div class="product-content">
													<h3><a href="#">Common input with NO and NC outputs</a></h3>
													<div class="price">
														<span>Rs.1200</span>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="relay4-relays-store.html">
														<img src="img/product/relay3-1.png" alt="" />
														<img class="secondary-img" src="img/product/relay3-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="relay4-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
												...
												<div class="product-content">
													<h3><a href="#">Bidirectional normally open output</a></h3>
													<div class="price">
														<span>Rs.1300</span>
														<span class="old">Rs.1400</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="relay5-relays-store.html">
														<img src="img/product/safety relay.png" alt="" />
														<img class="secondary-img" src="img/product/safety relay2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="relay5-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p>The OptoMOS® line of Rapid Turn-On AC Power Relays use dual power SCR outputs to produce an alternative to optocoupler and Triac circuits. All devices in this series feature rapid turn-on switching characteristic.</p>
													<div class="product-action">
														<div class="button-top">
															<a href="relay1-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p>The DCNHS Series, A 750V DC Contactor Relay is a normally open (also known as monostable) relay with a resin body for corrosion resistance in harsh automotive environments. Ceramic brazing sealed contacts help ensure there is no leakage of electrical arc for safety. </p>
													<div class="product-action">
														<div class="button-top">
															<a href="relay2-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p>The OptoMOS® line of solid-state relays uses discrete semiconductor components and the patented OptoMOS® architecture to deliver fast, reliable, bounce-free switching in a compact design. From one of the world's smallest single-pole, 4-pin relays to multi-pole and multi-function devices</p>
													<div class="product-action">
														<div class="button-top">
															<a href="relay3-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p>The OptoMOS® line of solid-state relays uses discrete semiconductor components and the patented OptoMOS® architecture to deliver fast, reliable, bounce-free switching in a compact design</p>
													<div class="product-action">
														<div class="button-top">
															<a href="relay4-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p>These switches are robust enough to provide a blocking voltage of up to 800V ac peak. The input and output circuits are optically coupled to provide up to 5000VRMS of isolation and noise immunity between control and load circuits</p>
													<div class="product-action">
														<div class="button-top">
															<a href="relay5-relays-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
							...
							<div class="footer-widget">
								...
								<ul class="footer-contact">
									<li>
										...
										Addresss: Pakistan, Karachi, North Nazimabad, Aptech NN2
									</li>
									<li>
