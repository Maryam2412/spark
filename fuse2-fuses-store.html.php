						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/fuse-holder.png" data-zoom-image="img/product/fuse-holder.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<p>You will find a variety of fuse holder designs for different
										applications. The fuse holders are rated up to 30A
										from 250V to 600V.</p>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The fuse holders are rated up to 30A
														from 250V to 600V.</p>
													<ul id="product-desc-t">
														<li>Mounting: In-Line</li>
														<li>Voltage Rate max: 350</li>
														<li>Type: Cylindrical</li>
														<li>Empere: 10 </li>
