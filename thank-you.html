...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="breadcrumb-area-feedback">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<script>
			function initialize() {
			  var mapOptions = {
				zoom: 15,
				scrollwheel: false,
				center: new google.maps.LatLng(24.9389513,67.044948)
			  };
