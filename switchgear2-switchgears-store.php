							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/switchgear2-1.png" data-zoom-image="img/product/switchgear2-1.png" alt="" /></a></div>
											...
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													...
													<ul id="product-desc-t">
														<li>Rated Insulation Voltage (Ui):
															1000 V</li>
														<li>Degree of Protection:
															IP44</li>
														<li>Rated Current (In):
															400 A</li>
														<li>Rated Voltage (Ur):
