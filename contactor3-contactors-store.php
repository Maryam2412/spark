						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/contactors3-1.png" data-zoom-image="img/product/contactors3-1.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">Electromechanical 3P CONT</a></h3>
									<div class="price">
										<span>Rs.6500</span>
										<span class="old">Rs.7500</span>
									</div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Contactors - Electromechanical 3P CONT S 24V DC 1NO1NC consists of 1 pole, 2 pole, 3 pole, and 4 pole contactors</p>
													<ul id="product-desc-t">
														<li>Coil Type:	DC Type</li>
														<li>Brand:	Carlo Gavazzi</li>
														<li>Product Type:	Electromechanical Contactors</li>
														<li>Manufacturer:	Carlo Gavazzi </li>
