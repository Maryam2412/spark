					...
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="relay-store.html">relays</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/relay1-1.png" data-zoom-image="img/product/relay1-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The DCNHS Series, A 750V DC Contactor Relay is a normally open (also known as monostable).</p>
													<ul id="product-desc-t">
														<li>Wide range of contact switching capability from 40A to 100A</li>
														<li>Normally open relay design for versatile functionality</li>
														<li>Resin housing for superior corrosion resistance</li>
														<li>Ceramic brazing sealed contacts ensure maximum safety </li>
