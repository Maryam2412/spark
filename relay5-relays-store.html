							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/safety relay.png" data-zoom-image="img/product/safety relay.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>For use with non-contact safety switches (up to 30), tongue switches, trapped key interlock switches etc.</p>
													<ul id="product-desc-t">
														<li>
															Power supply:	24V AC/DC; -15%/+10%</li>
														<li>Current consumption:	2W (DC); 5VA (AC)</li>
														<li>Operating temperature:	-20°C to +60°C</li>
														<li>Reaction time:	20ms </li>
														<li>Housing:	Polycarbonate</li>
														<li>Weight:	178g</li>
