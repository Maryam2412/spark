							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/relay2-1.png" data-zoom-image="img/product/relay2-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The OptoMOS® line of solid-state relays uses discrete semiconductor components.</p>
													<ul id="product-desc-t">
														<li>Low drive current</li>
														<li>High reliability</li>
														<li>Provides galvanic input to output isolation</li>
														<li>Replace electromechanical relays </li>
														<li>Replace mechanical switches</li>
													</ul>
												</div>
											</div>
