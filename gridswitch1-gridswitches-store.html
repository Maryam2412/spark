										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Knightsbridge CUGM23 White Curved Edge 20AX 2-way Retractive Switch Module (Centre Off)</p>
													<ul id="product-desc-t">
														<li>20AX rated</li>
														<li>2-way retractive switch - centre off</li>
														<li>Front mounting grid module</li>
														<li>Supplied in Knightsbridge rip top polybag with euro slot </li>
													</ul>
												</div>
											</div>
