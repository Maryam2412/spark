						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/gridswitch3-1.png" data-zoom-image="img/product/gridswitch3-1.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									<h3><a href="#">Radiant® Smart Outlet With Netatmo </a></h3>
									<div class="price">
										<span>Rs.7999</span>
										<span class="old">Rs.8899</span>
									</div>
