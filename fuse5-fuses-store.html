...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="breadcrumb-area-fuses">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="shop.html">Fuses</a> <span class="divider">|</span></li>
						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/fuse2-1.png" data-zoom-image="img/product/fuse2-1.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">Withstand Glass Body Cartridge Fuse</a></h3>
									<div class="price">
										<span>Rs.1500</span>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The 213 Series is a 5x20mm time-lag, surge-withstand, glass body cartridge fuse.</p>
													<ul id="product-desc-t">
														<li>Conforms to EN/IEC/K/J 60127-1 and EN/IEC/K/J 60127-2</li>
														<li>Available in cartridge and axial lead form</li>
														<li>RoHS compliant and lead-free</li>
														<li>Conforms to GB 9364.1 and GB 9364.2 </li>
														<li>Recognized to UL/CSA/NMX 248-1</li>
