							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/fuses1.png" data-zoom-image="img/product/fuses1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Potential Transformer (PT) fuses are current limiting fuses with high interrupting ratings.</p>
													<ul id="product-desc-t">
														<li>Amps (A): 10</li>
														<li>Interrupting Rating: 37.5 kA @ 625 Vac</li>
														<li>VAC (V): 600</li>
