					...
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="switchgears-store.html">switch gears</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/switchgear1-1.png" data-zoom-image="img/product/switchgear1-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Super-slim switchgear for wind segment ABB's tailor-made switchgear for wind turbines.</p>
													<ul id="product-desc-t">
														<li>Product Net Width:
															38 mm</li>
														<li>Product Net Height:
															37 mm</li>
														<li>Product Net Depth / Length:
															123 mm</li>
