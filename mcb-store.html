								...
								<div role="tabpanel" class="tab-pane active" id="home">
									<div class="row">
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="mcb1-mcbs-store.html">
														<img src="img/product/mcb1-1.png" alt="" />
														<img class="secondary-img" src="img/product/mcb1-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="mcb1-mcbs-store.html" ><i class="fa fa-search"></i></a>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="mcb2-mcbs-store.html">
														<img src="img/product/mcb2-1.png" alt="" />
														<img class="secondary-img" src="img/product/mcb2-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="mcb2-mcbs-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="mcb3-mcbs-store.html">
														<img src="img/product/mcb3-1.png" alt="" />
														<img class="secondary-img" src="img/product/mcb3-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="mcb3-mcbs-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													...
													<div class="product-action">
														<div class="button-top">
															<a href="mcb4-mcbs-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
