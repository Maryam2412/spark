					...
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="mcb-store.html">mcb's</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/mcbs-pole.png" data-zoom-image="img/product/mcbs-pole.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Industrial MCBs are much more reliable than the domestic ones.</p>
													<ul id="product-desc-t">
														<li>Large choice of breaking capacities and tripping curves: B,C,D..</li>
														<li>Compliance with standards: IS/IEC 60898, IEC/EN 60898 and IEC 60947-2</li>
														<li>ISI and CE marked</li>
														<li>Suitable for isolation in accordance with industrial standards: IEC 60947 </li>
														<li>Optional add-on earth leakage modules: xC60 Vigi</li>
														<li>Suitable for DC application: 60Vdc per pole</li>
													</ul>
												</div>
											</div>
