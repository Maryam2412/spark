					...
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="shop.html">capacitors</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/capacitors.png" data-zoom-image="img/product/capacitors.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Available in round (R) and oval case options.</p>
													<ul id="product-desc-t">
														<li>Type: dual</li>
														<li>Capacitance: 10 + 10</li>
														<li>Frequancy: 50/60 Hz</li>
														<li>Tolerance: 3% </li>
														<li>Operating Temperature: -40C to 70C</li>
														<li>Operating Life: 22000 hr</li>
														<li>Input Voltage: 440</li>
													</ul>
												</div>
											</div>
