						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/contactors5-1.png" data-zoom-image="img/product/contactors5-1.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">Electromechanical 250A </a></h3>
									<div class="price">
										<span>Rs.6000</span>
										<span class="old">Rs.6100</span>
									</div>
											...
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													...
													<ul id="product-desc-t">
														<li>Coil Voltage:	24 VDC</li>
														<li>Contact Current Rating:	250 A</li>
														<li>Coil Type:	DC Type</li>
														<li>Switching Voltage:	1 kVDC </li>
