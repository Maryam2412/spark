						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/arteor-grid-switch.png" data-zoom-image="img/product/arteor-grid-switch.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">Arteor Surround Plate 3 Module </a></h3>
									<div class="price">
										<span>Rs.1799</span>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Arteor™ offers a range of carefully crafted masterpieces to give any space an elegant yet discrete look.</p>
													<ul id="product-desc-t">
														<li>Operating / setting temperature	-5-50 °C</li>
														<li>Storage temperature	-10-70 °C</li>
														<li>A Wider Choice of Metals</li>
														<li>Global Solutions: Arteor truly international </li>
														<li>The Right Mood Arteor Lighting Solutions</li>
