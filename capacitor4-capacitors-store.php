...
<html class="no-js" lang="">
    <head>
        ...
        <title>Product Details || Spark</title>
					...
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="#">capacitors</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/capacitors4-1.png" data-zoom-image="img/product/capacitors4-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>KEMET X7R Commercial Grade SMD ≤250V MLCCs are a family of Class II ceramic chip capacitors used for bypass and decoupling applications.</p>
													<ul id="product-desc-t">
														<li>Type: General Type MLCCs</li>
														<li>Capacitance: 0.1 uF</li>
														<li>Frequancy: 50/60 Hz</li>
														<li>Tolerance: 5 % </li>
														<li>Operating Temperature: -55 C to 125 C</li>
														<li>Brand:	KEMET</li>
														<li>Input Voltage: 110-125</li>
													</ul>
												</div>
											</div>
