					...
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="lighting-store.html">lighting</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/lighting saver.png" data-zoom-image="img/product/lighting saver.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Energy saving lamp in spiral shape, with superior performance, long life.</p>
													<ul id="product-desc-t">
														<li>Simple installation-no ballast needed</li>
														<li>Save your money with long life-time</li>
														<li>Perfect energy-saving solution</li>
														<li>Suitable for frequent switching </li>
														<li>Flawless ignition at -10°C and up</li>
