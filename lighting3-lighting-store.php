							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/saver2-1.png" data-zoom-image="img/product/saver2-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>To replace incandescent lamps in general lighting applications, Not suitable for dimming or for electronic devices</p>
													<ul id="product-desc-t">
														<li>U-shaped energy-saving lamp</li>
														<li>High energy efficiency</li>
														<li>Long-life alternative to incandescent lamps</li>
														<li>Energy saving </li>
														<li>Fewer lamp replacements</li>
