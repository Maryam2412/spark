							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/capacitors3-1.png" data-zoom-image="img/product/capacitors3-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Murata EVA Compact Multilayer Ceramic Capacitors (MLCCs) feature an extended creepage distance.</p>
													<ul id="product-desc-t">
														<li>Lead free and non-polar with excellent solderability</li>
														<li>10pF to 47μF capacitance range</li>
														<li>-55°C to +125°C operating temperature</li>
														<li>11 case sizes available from 0402 to 2225 </li>
														<li>6.3VDC to 250VDC voltage range</li>
														<li>±5%, ±10%, and ±20% tolerances available</li>
