						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/fuse3-2.png" data-zoom-image="img/product/fuse3-2.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">1000 VDC Solar Fuse</a></h3>
									<div class="price">
										<span>Rs.1400</span>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The SPFR series was designed to meet the growing needs of the solar industry.</p>
													<ul id="product-desc-t">
														<li>DC Voltage rating meets European system</li>
														<li>Multiple amperage ratings</li>
														<li>RoHS compliant</li>
														<li>Class H Dimensions </li>
														<li>Full Range Protection</li>
