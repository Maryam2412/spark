							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/capacitor2-1.png" data-zoom-image="img/product/capacitor2-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The HHS Series Hard Start Kits are used to improve the starting torque of single-phase electric motors.</p>
													<ul id="product-desc-t">
														<li>Type: single</li>
														<li>Capacitance: 243-292</li>
														<li>Frequancy: 50/60 Hz</li>
														<li>Tolerance: 3% </li>
														<li>Operating Temperature: -40 C to 65 C</li>
														<li>Terminal: 5 wire leads</li>
