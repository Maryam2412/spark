						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/gridswitch2-1.png" data-zoom-image="img/product/gridswitch2-1.png" alt="" /></a></div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12 shop-list shop-details">								
								<div class="product-content">
									...
									<h3><a href="#">Smart Plug-In Switch with Netatmo </a></h3>
									<div class="price">
										<span>Rs.5999</span>
										<span class="old">Rs.6899</span>
									</div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Netatmo leverages leading Netatmo technology to provide an ideal solution for larger homes with many smart products.</p>
													<ul id="product-desc-t">
														<li>Smart Gateway</li>
														<li>Control lamps, curling irons, fans, and other small appliances from smartphones</li>
														<li>Features ultra-reliable performance through a robust</li>
														<li>Flexibly fits a home's unique needs with a variety of supported smart switches </li>
														<li>Installs easily, no wiring required. </li>
