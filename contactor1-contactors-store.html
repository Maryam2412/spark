...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="breadcrumb-area-contactors">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="breadcrumb-list">
							...
							<ul>
								...
								<li><a href="shop.html">contactors</a> <span class="divider">|</span></li>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/contactor1.png" data-zoom-image="img/product/contactor1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>The HCC Series definite purpose contactors consists of 1 pole, 2 pole, 3 pole, and 4 pole contactors from 20 amperes.</p>
													<ul id="product-desc-t">
														<li>Full Load Current Inductive(A): 30</li>
														<li>Full Load Current Resistive(A): 40A @ 600VAC</li>
														<li>Coil Voltage: 120</li>
														<li>Input Voltage Maximum (V): 132 </li>
														<li>Contactor Form per Circuit: 1 pole NO with shunt</li>
