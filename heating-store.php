...
<html class="no-js" lang="">
    ...
    <body>
		...
		<div class="breadcrumb-area-heating">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
								...
								<div role="tabpanel" class="tab-pane active" id="home">
									<div class="row">
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="heating1-heating-store.html">
														<img src="img/product/fan1-1.png" alt="" />
														<img class="secondary-img" src="img/product/fan1-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="heating1-heating-store.html" ><i class="fa fa-search"></i></a>
												...
												<div class="product-content">
													<h3><a href="#">4" CLIP FAN</a></h3>
													<div class="price">
														<span>Rs.7000</span>
														<span class="old">Rs.8000</span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-4 col-sm-4">
											<div class="single-product">
												<div class="product-img">
													<a href="heating2-heating-store.html">
														<img src="img/product/fan2-1.png" alt="" />
														<img class="secondary-img" src="img/product/fan2-2.png" alt="" />
													</a>
													<span class="tag-line">new</span>
													<div class="product-action">
														<div class="button-top">
															<a href="heating2-heating-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
														</div>
														<div class="button-cart">
															<button><i class="fa fa-shopping-cart"></i> add to cart</button>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p> 4-inch clip fan features a heavy-duty clip that makes it easy to secure onto your baby stroller or crib.  A light-weight construction makes carrying it around hassle-free!</p>
													<div class="product-action">
														<div class="button-top">
															<a href="heating1-heating-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
										...
										<div class="col-md-12">
											<div class="single-product">
												...
												<div class="product-content">
													...
													<p>GOOSENECK CLIP FAN features a heavy-duty clip that makes it easy to secure onto your baby stroller or crib.  A light-weight construction makes carrying it around hassle-free!</p>
													<div class="product-action">
														<div class="button-top">
															<a href="heating2-heating-store.html" ><i class="fa fa-search"></i></a>
															<a href="#" ><i class="fa fa-heart"></i></a>
