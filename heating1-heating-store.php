							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/fan1-1.png" data-zoom-image="img/product/fan1-1.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>4-inch clip fan features a heavy-duty clip that makes it easy to secure </p>
													<ul id="product-desc-t">
														<li>Easy to use</li>
														<li>Heavy duty clip</li>
														<li>2 AA batteries</li>
														<li>light weight constructure </li>
														<li>Adjustable neck</li>
														<li>Fan cover tight opening</li>
														<li>40 blades</li>
													</ul>
												</div>
											</div>
