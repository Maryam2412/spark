							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/fuse.png" data-zoom-image="img/product/fuse.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Made for use with Blue Sea Systems ST Glass Fuse Blocks and AGC or MDL fuse holders.</p>
													<ul id="product-desc-t">
														<li>Dimensions: 1 1/4" (32mm)L x 1/4" (6.30mm) diameter</li>
														<li>Maximum Voltage: 250V AC, 32V DC</li>
														<li>Weight: 0.03lb (0.01 kg)</li>
