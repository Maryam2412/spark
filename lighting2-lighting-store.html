...
<html class="no-js" lang="">
    <head>
        ...
        <title>Product Details || Sparks</title>
							...
							<div class="col-md-5 col-sm-5 col-xs-12">
								<div class="single-pro-tab-content">
									...
									<div class="tab-content">
										<div role="tabpanel" class="tab-pane active" id="home"><a href="#"><img class="zoom" src="img/product/saver.png" data-zoom-image="img/product/saver.png" alt="" /></a></div>
										  ...
										  <div class="tab-content">
											<div role="tabpanel" class="tab-pane active" id="tab-desc">
												<div class="product-tab-desc">
													<p>Energy saver among Philips compact fluorescent lamps, offering great value for money with quality.</p>
													<ul id="product-desc-t">
														
														<li>Cap-Base: E27</li>
														<li>Nominal lifetime: 6,000 hour(s) </li>
														<li>Switching Cycle: 6,000</li>
														<li>Lighting Technology: Compact Fluorescent Integrated</li>
														<li>Rated Lifetime (Hours): 6,000 hour(s)</li>
													</ul>
												</div>
											</div>
